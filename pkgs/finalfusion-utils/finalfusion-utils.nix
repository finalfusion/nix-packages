...
rec {
  ...
  crates = {
    ...
    "blas-src 0.3.0 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        crateName = "blas-src";
        version = "0.3.0";
        edition = "2015";
        sha256 = "1hcd27zf5w9rhqdgqgj1sj8xgnrzbamy1c29ra78fmh7cy4rlli1";
        authors = [
          "Ivan Ukhov <ivan.ukhov@gmail.com>"
          "Toshiki Teramura <toshiki.teramura@gmail.com>"
        ];
        dependencies = {
          "intel-mkl-src" = {
            packageId = "intel-mkl-src 0.4.0 (registry+https://github.com/rust-lang/crates.io-index)";
            optional = true;
          };
          "netlib-src" = {
          ...
          "openblas-src" = {
            packageId = "openblas-src 0.6.1 (registry+https://github.com/rust-lang/crates.io-index)";
            optional = true;
          };
        };
        features = {
    ...
    "cmake 0.1.41 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        version = "0.1.41";
        edition = "2015";
        sha256 = "1s94j7i7bkkpkbw94683a91yhs9x7xq5n8mvm93kpkljdasqh1ag";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = {
    ...
    "finalfusion 0.10.0 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        crateName = "finalfusion";
        version = "0.10.0";
        edition = "2018";
        sha256 = "1ynb7h0gk1b2240y6v5v636499rj2hsgbrf2xy7ds3d8jz4wpdnk";
        authors = [
    ...
    "finalfusion-utils 0.9.1 (path+file:///home/daniel/git/finalfusion-utils)"
      = rec {
        ...
        dependencies = {
          ...
          "failure" = "failure 0.1.5 (registry+https://github.com/rust-lang/crates.io-index)";
          "finalfusion" = "finalfusion 0.10.0 (registry+https://github.com/rust-lang/crates.io-index)";
          "ndarray" = "ndarray 0.12.1 (registry+https://github.com/rust-lang/crates.io-index)";
    ...
    "intel-mkl-src 0.4.0 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        crateName = "intel-mkl-src";
        version = "0.4.0";
        edition = "2015";
        sha256 = "07y85dxklzkp9s1wf8c1c6zrcs1svi9ckj8kgx9gky30qbp06h3p";
        authors = [
          "Toshiki Teramura <toshiki.teramura@gmail.com>"
        ];
        buildDependencies = {
    ...
    "lapack-src 0.3.0 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        crateName = "lapack-src";
        version = "0.3.0";
        edition = "2015";
        sha256 = "0dlmii9mwlrakvyhrw309djz76gb82krq00akr7qb4jclc9rzmg2";
        authors = [
          "Ivan Ukhov <ivan.ukhov@gmail.com>"
          "Toshiki Teramura <toshiki.teramura@gmail.com>"
        ];
    ...
    "ndarray-linalg 0.11.1 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        crateName = "ndarray-linalg";
        version = "0.11.1";
        edition = "2018";
        sha256 = "1h4ncyxd6fxlp5q662dqw2bagd9vq2pv9fjsscv9ayppyn08nwxq";
        authors = [
          "Toshiki Teramura <toshiki.teramura@gmail.com>"
        ];
        dependencies = {
          "blas-src" = {
            packageId = "blas-src 0.3.0 (registry+https://github.com/rust-lang/crates.io-index)";
            usesDefaultFeatures = false;
          };
          "cauchy" = "cauchy 0.2.2 (registry+https://github.com/rust-lang/crates.io-index)";
          "lapack-src" = {
            packageId = "lapack-src 0.3.0 (registry+https://github.com/rust-lang/crates.io-index)";
            usesDefaultFeatures = false;
          };
    ...
    "netlib-src 0.7.4 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        buildDependencies = {
          "cmake" = "cmake 0.1.41 (registry+https://github.com/rust-lang/crates.io-index)";
        };
        features = {
    ...
    "openblas-src 0.6.1 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        crateName = "openblas-src";
        version = "0.6.1";
        edition = "2015";
        sha256 = "1vwfydsymvmc7bpqnp759lcs8laxcf929fa1zjdgvjxwad8a0r6r";
        authors = [
          "Corey Richardson <corey@octayn.net>"
          "Ivan Ukhov <ivan.ukhov@gmail.com>"
    ...
    "reductive 0.3.0 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          ...
          "ndarray" = "ndarray 0.12.1 (registry+https://github.com/rust-lang/crates.io-index)";
          "ndarray-linalg" = {
            packageId = "ndarray-linalg 0.11.1 (registry+https://github.com/rust-lang/crates.io-index)";
            optional = true;
          };
